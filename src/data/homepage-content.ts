...
export const seoContent: ContentSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Different games accept different words, so choosing the correct dictionary matters. Scrabble and Words With Friends each use their own distinctive word lists and letter values, while Wordle focuses on valid five-letter answers. Our tools let you select the right mode so the results always reflect the game you are actually playing.",
